        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1 text-center">
                    <h2>Select the base sequence to perform insertion</h2>
                    <h4>The selected base sequence from drop down list will be inserted into next base sequence</h4>
                    <hr class="small">
                    <br><br><br><br>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="portfolio-item">
                                <form method="POST" action="{{ URL::route('mod_insertion_show', array($palmtree->id))}}">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            @for ($i = 0; $i < strlen($ori_gene_array); $i++)
                                                @if ($i == $palmtree->ins_index-1)
                                                    <td>
                                                        <select name="ins_base_seq">
                                                            <option value="-"> - </option>
                                    ...
                                    <a button type="button" style="background-color: #006666; color: #CCCCCC; border: none;" class="btn btn-primary" href="{{ URL::route('mod_insertion_edit', array($palmtree->id))}}">
                                    Edit
                                    </a> &nbsp;
