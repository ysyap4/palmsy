...
<head>
    ...
    <title>Palmsy | Deletion of {{$palmtree->scientific_name}}</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1 text-center">
                    <h2>Select the base sequence to perform deletion</h2>
                    <h4>The selected base sequence will be deleted from gene sequence</h4>
                    <hr class="small">
                    <br><br><br><br>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="portfolio-item">
                                <form method="POST" action="{{ URL::route('mod_deletion_show', array($palmtree->id))}}">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            @for ($i = 0; $i < strlen($ori_gene_array); $i++)
                                                <td>
                                                    <input type="radio" name="del_index" value="{{$i}}">
                                                </td>
                                            @endfor
                                        </tr>
                                    </table>
