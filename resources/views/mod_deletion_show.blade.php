                        ...
                        <div class="col-md-6">
                            <div class="portfolio-item">
                               ...
                               <table class="table table-striped table-bordered">
                                ...
                                <br><br>
                                <form method="POST" action="{{ URL::route('mod_deletion_save', array($palmtree->id, $mod_gene_array))}}" novalidate>
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                        <button type="submit" style="background-color: #006666; color: #CCCCCC; border: none;" class="btn btn-primary">
                                        Save
                                        </button> &nbsp;&nbsp;
                                        <a button type="button" style="background-color: #006666; color: #CCCCCC; border: none;" class="btn btn-primary" href="{{ URL::route('mod_deletion', array($palmtree->id))}}">
                                        Back
                                        </a>
                                </form>
