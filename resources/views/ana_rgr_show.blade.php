                        ...
                        <div class="portfolio-item">
                            <form method="POST" action="{{ URL::route('ana_rgr_show', array($modification->id))}}">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    ...
                                    <br>
                                    <h4> W2 = &nbsp;&nbsp;&nbsp;
								        <input type="number" name="w2" value="{{ $w2 }}">
                                    <br> W1 = &nbsp;&nbsp;&nbsp;
								    	<input type="number" name="w1" value="{{ $w1 }}">
                                    <br> t2 = &nbsp;&nbsp;&nbsp;&nbsp;
								    	<input type="number" name="t2" value="{{ $t2 }}">
                                    <br> t1 = &nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="number" name="t1" value="{{ $t1 }}">
                                    </h4>
                                    <br>
                    ...
                    <div class="row"> 
                        <div class="col-md-6">
                            ...
                            <br><br>
                                <h2> Calculation </h2>
                                <br>
                                <h3> The RGR value is <strong> {{$rgr_value}} </strong> g g−1 d−1. </h3>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="portfolio-item">
                            <form method="POST" action="{{ URL::route('ana_rgr_save', array($modification->id, $rgr_value))}}" novalidate>
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
