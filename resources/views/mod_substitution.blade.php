...
<head>
    ...
    <title>Palmsy | Substitution of {{$palmtree->scientific_name}}</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1 text-center">
                    <h2>Select the base sequence to perform substitution</h2>
                    <h4>The selected base sequence from drop down list will be substituted into base sequence</h4>
                    <hr class="small">
                    <br><br><br><br>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="portfolio-item">
                                    ...
                                    <h3>modifying gene sequence</h3>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="portfolio-item">
                                <form method="POST" action="{{ URL::route('mod_substitution_show', array($palmtree->id))}}">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <table class="table table-striped table-bordered">
                                        <tr>
                                            @for ($i = 0; $i < strlen($ori_gene_array); $i++)
                                            <td> {{$i+1}} </td>
                                            @endfor
                                        </tr>
                                        <tr>
                                            @for ($i = 0; $i < strlen($ori_gene_array); $i++)
                                            <td><b> {{$ori_gene_array[$i]}} </b></td>
                                            @endfor
                                        </tr>
                                        <tr>
                                            @for ($i = 0; $i < strlen($ori_gene_array); $i++)
                                    ...
                                    <button type="submit" style="background-color: #006666; color: #CCCCCC; border: none;" class="btn btn-primary">Modify</button> &nbsp;
                                    <a button type="button" style="background-color: #006666; color: #CCCCCC; border: none;" class="btn btn-primary" href="{{ URL::route('mod_substitution_edit', array($palmtree->id))}}">
                                    Edit
                                    </a> &nbsp;
                                    <a button type="button" style="background-color: #006666; color: #CCCCCC; border: none;" class="btn btn-primary" href="{{ URL::route('mod_select_mutation', array($palmtree->id))}}">
                                    Back
                                    </a>
                                </form>
