...
<head>
    ...
    <title>Palmsy | Modification of {{$palmtree->scientific_name}}</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1 text-center">
                    <h2>Select the type of mutation to modify</h2>
                    <hr class="small">
                    <br><br><br><br>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="portfolio-item">
                                    ...
                                    <h3>original gene sequence</h3>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="portfolio-item">
							   <h2 class="bg-info"> {{$palmtree->gene}} </h2>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="portfolio-item">
									<br><br><br><br>
									   <a button type="button" style="background-color: #7A3E48; color: #FEFCD7; border: none;" class="btn btn-primary" href="{{ URL::route('mod_insertion', array($palmtree->id))}}">
                                        Insertion
                                        </a> &nbsp;&nbsp;
									   <a button type="button" style="background-color: #AE8F60; color: #FEFCD7; border: none;" class="btn btn-success" href="{{ URL::route('mod_deletion', array($palmtree->id))}}">
                                       Deletion
                                       </a> &nbsp;&nbsp;
									   <a button type="button" style="background-color: #A6635D; color: #FEFCD7; border: none;" class="btn btn-info" href="{{ URL::route('mod_substitution', array($palmtree->id))}}">
                                       Substitution
                                       </a> &nbsp;&nbsp;
									   <a button type="button" style="background-color: #84596B; color: #FEFCD7; border: none;" class="btn btn-warning" href="{{ URL::route('mod_duplication', array($palmtree->id))}}">
                                       Duplication
                                       </a>
									<!--<input type="number" name="t1"> <br>-->
									<br>
									<!--<input type="submit" onclick="" value="Analyze">-->
                            </div>
                        </div>
                    </div>
