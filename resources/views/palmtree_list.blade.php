...
<body id="top" class="header">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="background:rgba(135,226,147,110.75);">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="{{ URL::route('user_index') }}" style="color:#043F1D;"><b>Administration</b></a>
                    </li> 
                    <li>
                        <a class="page-scroll" href="{{ URL::route('palmtree_list') }}" style="color:#043F1D;"><b>Detail Of Palm Tree</b></a>
                    </li>
                    <li>
