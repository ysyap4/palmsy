        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1 text-center">
                    <h2>Edit the base sequence index to enable substitution</h2>
                    <h4>The selected base sequence index will be able to perform substitution</h4>
                    <hr class="small">
                    <br><br><br><br>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="portfolio-item">
                                    ...
                                    <h3>editing substitution index</h3>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="portfolio-item">
                                <form method="POST" action="{{ URL::route('mod_substitution_edit_process', array($palmtree->id))}}">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            @for ($i = 0; $i < strlen($ori_gene_array); $i++)
                                                <td>
                                                    <input type="radio" name="sub_index" value="{{$i+1}}">
                                                </td>
                                            @endfor
                                        </tr>
                                    </table>
                                    ...
                                    <br>
                                    <button type="submit" style="background-color: #006666; color: #CCCCCC; border: none;" class="btn btn-primary">Save</button> &nbsp;
                                    <a button type="button" style="background-color: #006666; color: #CCCCCC; border: none;" class="btn btn-primary" href="{{ URL::route('mod_substitution', array($palmtree->id))}}">
                                    Back
                                    </a>
                                </form>
