                ...
                <div class="col-lg-10 col-lg-offset-1 text-center">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="portfolio-item">
                            <br><br>
                                <h3> A = number of seeds with both dominant phenotype </h3>
                                <h3> B = number of seeds with a dominant and a recessive phenotype </h3>
                                <h3> C = number of seeds with a dominant and a recessive phenotype </h3>
                                <h3> D = number of seeds with both recessive phenotype </h3>
                                <h3> x = number of seeds produced by palm tree </h3>
                                <br>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row"> 
                        <div class="portfolio-item">
                            <form method="POST" action="{{ URL::route('ana_sn_show', array($modification->id))}}">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <h3>Enter the following data:</h3>
                                    <br>
                                    <h4> x (number of seeds produced) = &nbsp;&nbsp;&nbsp;
                                        <input type="number" name="sn" value="{{$sn_value}}">
                                    <br><br>
                                    <h4> Dominant phenotype 1 = &nbsp;&nbsp;&nbsp;
                                        <input type="text" name="d1" value="{{$d1}}">
                                    <br> Dominant phenotype 2 = &nbsp;&nbsp;&nbsp;
                                        <input type="text" name="d2" value="{{$d2}}">
                                    <br> Recessive phenotype 1 = &nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="text" name="r1" value="{{$r1}}">
                                    <br> Recessive phenotype 2 = &nbsp;&nbsp;&nbsp;
                                        <input type="text" name="r2" value="{{$r2}}">
                                    </h4>
                                    <br>
                    ...
                    <div class="row"> 
                            ...
                            <div class="portfolio-item">
                            <br>
                            <h3> A = <strong> {{$sn_a}} </strong> ({{$d1}}, {{$d2}}) </h3>
                            <h3> B = <strong> {{$sn_b}} </strong> ({{$d1}}, {{$r2}}) </h3>
                            <h3> C = <strong> {{$sn_c}} </strong> ({{$r1}}, {{$d2}}) </h3>
                            <h3> D = <strong> {{$sn_d}} </strong> ({{$r1}}, {{$r2}}) </h3>
                            <br>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="portfolio-item">
                            <form method="POST" action="{{ URL::route('ana_sn_save', array($modification->id, $sn_value, $d1, $d2, $r1, $r2))}}" novalidate>
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
