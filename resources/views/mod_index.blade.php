...
<head>
    ...
    <title>Palmsy | Modification</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1 text-center">
                    <h2>Select the species to start modification</h2>
                    <hr class="small">
                    <div class="row">
                        @foreach($palmtree as $value)
                        <div class="col-md-6">
                            <div class="portfolio-item">
                                <a href="{{ URL::route('mod_select_mutation', array($value->id))}}">
                                    <img class="img-portfolio img-responsive" src="public/img/{{ $value->image_filename }}">
                                </a>
                                <h3> {{ $value->scientific_name }} | {{ $value->product_type }} </h3>
                            </div>
                        </div>
                        @endforeach    
                    </div>      
