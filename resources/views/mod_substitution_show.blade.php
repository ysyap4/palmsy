        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1 text-center">
                    <h2>Confirm the modified gene sequence</h2>
                    <hr class="small">
                    <br><br><br><br>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="portfolio-item">
                                    ...
                                    <h3>viewing original and modified gene sequence</h3>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="portfolio-item">
							   
                               <h3 style="text-align: left;">original gene sequence</h3>
                               <table class="table table-striped table-bordered">
                                ...
                                <h3 style="text-align: left;">modified gene sequence</h3>
                                <table class="table table-striped table-bordered">
                                    <tr>
                                        @for ($i = 0; $i < strlen($mod_gene_array); $i++)
                                        @if ($i == $palmtree->sub_index-1)
                                                <td><b style="color:#915B51;"> {{$i+1}} </b></td>
                                            @else
                                                <td> {{$i+1}} </td>
                                            @endif
                                        @endfor
                                    ...
                                    <tr>
                                        @for ($i = 0; $i < strlen($mod_gene_array); $i++)
                                            @if ($i == $palmtree->sub_index-1)
                                                <td><b style="color:#915B51;"> {{$mod_gene_array[$i]}} </b></td>
                                            @else
                                ...
                                <br><br> 
                                <form method="POST" action="{{ URL::route('mod_substitution_save', array($palmtree->id, $mod_gene_array))}}" novalidate>
